...
def agent(hyperparameters,constants,focused_learning=True):
    ...
    def actor_step(observation,state,params,rng_key):
        ...
        for action_dimension in keys:
            ...
            action_distribution[action_dimension] = jax.nn.softmax(hyperparameters["beta_Q"]*new_qt_dim)
        ...
        for action_dimension in keys:
            action_dimension_hyperparams = hyperparameters[action_dimension]
            action_distribution[action_dimension] = jax.nn.softmax(softmaxed_omega[action_dimension]*hyperparameters["beta_Q"]*new_qt[action_dimension])
