...
def get_extrapolated_deltab(hist_u,hist_qs,action_filter,
    ...
    # The usual "counting" step
    db = jnp.einsum("ti,tj,tu,t->ijut",post_qs,pre_qs,hist_u,action_filter) 
    
    # Summed across all timesteps :
